...
function mapMarketToCacheEntry(market: Market) {
  return {
    id: market.id,
    ...
    thisOdds: market.thisOdds !== null ? Number(market.thisOdds) : undefined,
    thatOdds: market.thatOdds !== null ? Number(market.thatOdds) : undefined,
    liquidity: market.liquidity !== null ? Number(market.liquidity) : undefined,
